...
{
    self.addressZipField = [[PTKTextField alloc] initWithFrame:CGRectMake(kPTKViewCardCVCFieldStartX, 0, 80, 20)];
    self.addressZipField.delegate = self;
    self.addressZipField.placeholder = [self.class localizedStringWithKey:@"placeholder.card_cvc" defaultValue:@"CVC"];
